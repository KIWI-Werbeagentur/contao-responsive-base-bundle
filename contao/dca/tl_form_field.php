...
$GLOBALS['TL_DCA']['tl_form_field']['subpalettes']['responsiveContainer_'] = 'responsiveCols,responsiveOffsets'; // kept for BC
...
$GLOBALS['TL_DCA']['tl_form_field']['subpalettes']['responsiveContainer_responsiveContainerSizes'] = '';
