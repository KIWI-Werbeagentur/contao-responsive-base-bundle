...
$GLOBALS['TL_LANG']['MSC']['breakpoint']['xs'][0] = "Standard (Smartphone)";
...
$GLOBALS['TL_LANG']['MSC']['spacings']['default'][0] = "Standard";
$GLOBALS['TL_LANG']['MSC']['spacings']['none'][0] = "Kein Abstand";
$GLOBALS['TL_LANG']['MSC']['spacings']['gap'][0] = "Halber Rasterabstand";
$GLOBALS['TL_LANG']['MSC']['spacings']['gap-full'][0] = "Voller Rasterabstand";
$GLOBALS['TL_LANG']['MSC']['spacings']['xs'][0] = "Extra klein";
$GLOBALS['TL_LANG']['MSC']['spacings']['sm'][0] = "Klein";
