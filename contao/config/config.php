...
use Kiwi\Contao\ResponsiveBaseBundle\EventListener\LoadDataContainerListener;
...
$GLOBALS['responsive']['tl_module']['includePalettes']['container'] = ['newslist', 'eventlist', 'vacancieslist'];
